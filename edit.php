        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" placeholder="isi nama" name="nama" id="nama" required class="form-control" value="<?= $pegawai["nama"] ?>"></td>
                </tr>
                <tr>
                    <td><label for="jabatan">Jabatan</label></td>
                    <td>:</td>
                    <td><input type="text" placeholder="isi jabatan" name="jabatan" id="jabatan" required class="form-control" value="<?= $pegawai["jabatan"] ?>"></td>
                </tr>
                <tr>
                    <td><label for="umur">Umur</label></td>
                    <td>:</td>
                    <td><input type="text" placeholder="isi umur" name="umur" id="umur" required class="form-control" value="<?= $pegawai["umur"] ?>"></td>
                </tr>
                <tr>
